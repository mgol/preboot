...
import {getInlinePrebootCodeDefinition, getInlinePrebootCodeInvocation}
  from './api/inline.preboot.code';
...
export function PREBOOT_FACTORY(doc: Document,
  ...
  return () => {
    ...
    if (isPlatformServer(platformId)) {
      const inlineCodeDefinition = getInlinePrebootCodeDefinition(prebootOpts);
